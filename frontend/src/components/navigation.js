        ...
        return(
            <div>
                    ...
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                        <NavLink className="nav-link" to="/reportoptions">Report Options</NavLink>
                        </li>
                        <li className="nav-item">
                        <NavLink className="nav-link" to="/logic">Logic</NavLink>
                        </li>
                        <li className="nav-item">
                        <NavLink className="nav-link" to="/modelparams">Model Params</NavLink>
                        </li>
